  ...
  constructor(props){
    ...
    this.state = {
      ...
      routes: [
        ...
        { key: 'Starred', title: 'Rate', icon: 'star',color: '#ffc107', navigation: this.props.navigation,father:this},
        { key: 'UserProfile', title: 'Profile', icon: 'person' ,color: 'blue', navigation: this.props.navigation,},
      ],
    };
