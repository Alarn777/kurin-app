      ...
      return (
        <View style={{width:'80%',alignSelf:'center'}}>
          <Text style={styles.text}>
            We have found no one matching your search...
      ...
      if(this.state.edit){
        return (
          ...
          <ThemeProvider>
            <Card title="My Home">
              ...
              />
              <Text style={{fontSize:20,margin:10}} h5>To clean:</Text>
              <CheckBox
                title='Floor'
        ...
        return (
          <ThemeProvider style={styles.main}>
            ...
            <Card title="My Home">
              <ListItem
                title={"Address: " + this.state.user.address}
              />
              <ListItem
                title={"Size of the apartment: " + this.state.apSize}
              />
              <ListItem
                title={"Floor: " + this.state.floorNum}
              />
