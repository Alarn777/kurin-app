...
class Home extends React.Component {
  ...
  async fetchUser(data) {
    axios.post(Consts.host + '/getCleanerByEmail', data)
      .then(res => {
    ...
    if(this.state.events.length === 0){
      return (
        <View style={{width:'80%',alignSelf:'center'}}>
          <Text style={styles.text}>
            We have found no events waiting for you...
      ...
      return (
        <View>
          ...
          <Button
            buttonStyle={{alignSelf:'center',width:'75%',margin:20,backgroundColor:"#8BC34A"}}
            title='Back to Main'
  ...
  render() {
    ...
    if(this.state.loadingEventsTrigger){
      ...
      >
        <Image style={{height:200,width: 200}} source={{uri: 'http://www.animatedimages.org/data/media/1095/animated-cleaning-image-0048.gif'}} />
      ...
      if(this.state.edit){
          ...
          <ThemeProvider>
            ...
            <Card title="My Home">
              ...
              <RadioForm
                ...
                buttonColor={'#8BC34A'}
                animation={true}
                onPress={(value) => {this.setState({available:value})}}
              />
              </View>
              {/*<Input*/}
              {/*  containerStyle={{margin:10}}*/}
              ...
              {/*/>*/}
              <Text style={{fontSize:20,margin:10}} h5>I can clean:</Text>
              <CheckBox
                title='Floor'
        ...
        return (
          <ThemeProvider style={styles.main}>
            ...
            <Card title="My Home">
              <ListItem
                title={"About me: " + this.state.user.about}
              ...
              <Button
                ...
                title='Edit' onPress={this.editMode}/>
              </Card>
